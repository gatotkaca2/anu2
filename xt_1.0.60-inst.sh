...
echo -e "${jeshile} ┌─────────────────────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │                                                                         │ \e[0m"
echo -e "${jeshile} │                          Install start                                  │ \e[0m"
echo -e "${jeshile} │                                                                         │ \e[0m"
echo -e "${jeshile} └─────────────────────────────────────────────────────────────────────────┘\e[0m"
sleep 3
...
wget https://nchc.dl.sourceforge.net/project/xtre/www_dir.tar.gz -O /tmp/www_dir.tar.gz
#
if [ -d /var/www/html ];
then
...
echo "####################################################################################"
echo " "
echo "Xtream Codes 1.0.60 edited by Gatot kaca public Version"
echo " "
